...
def product_list():
    ...
    while True:
        ...
        if int(aij[0]) == 1:
            ...
            janela['be11'].update(visible=False)
            janela['bp11'].update(visible=True)
        else:
            janela["status_a11"].update(negative, text_color='red')
            janela['be11'].update(visible=True)
            janela['bp11'].update(visible=False)
        #a12
        if int(aij[1]) == 1:
            janela["status_a12"].update(positive, text_color='green')
            janela['be12'].update(visible=False)
            janela['bp12'].update(visible=True)
        else:
            janela["status_a12"].update(negative, text_color='red')
            janela['be12'].update(visible=True)
            janela['bp12'].update(visible=False)
        #a13
        if int(aij[2]) == 1:
            janela["status_a13"].update(positive, text_color='green')
            janela['be13'].update(visible=False)
            janela['bp13'].update(visible=True)
        else:
            janela["status_a13"].update(negative, text_color='red')
            janela['be13'].update(visible=True)
            janela['bp13'].update(visible=False)
        #a21
        if int(aij[3]) == 1:
            janela["status_a21"].update(positive, text_color='green')
            janela['be21'].update(visible=False)
            janela['bp21'].update(visible=True)
        else:
            janela["status_a21"].update(negative, text_color='red')
            janela['be21'].update(visible=True)
            janela['bp21'].update(visible=False)
        #a22
        if int(aij[4]) == 1:
            janela["status_a22"].update(positive, text_color='green')
            janela['be22'].update(visible=False)
            janela['bp22'].update(visible=True)
        else:
            janela["status_a22"].update(negative, text_color='red')
            janela['be22'].update(visible=True)
            janela['bp22'].update(visible=False)
        #a23
        if int(aij[5]) == 1:
            janela["status_a23"].update(positive, text_color='green')
            janela['be23'].update(visible=False)
            janela['bp23'].update(visible=True)
        else:
            janela["status_a23"].update(negative, text_color='red')
            janela['be23'].update(visible=True)
            janela['bp23'].update(visible=False)
        #a31
        if int(aij[6]) == 1:
            janela["status_a31"].update(positive, text_color='green')
            janela['be31'].update(visible=False)
            janela['bp31'].update(visible=True)
        else:
            janela["status_a31"].update(negative, text_color='red')
            janela['be31'].update(visible=True)
            janela['bp31'].update(visible=False)
        #a32
        if int(aij[7]) == 1:
            janela["status_a32"].update(positive, text_color='green')
            janela['be32'].update(visible=False)
            janela['bp32'].update(visible=True)
        else:
            janela["status_a32"].update(negative, text_color='red')
            janela['be32'].update(visible=True)
            janela['bp32'].update(visible=False)
        #a33
        if int(aij[8]) == 1:
            janela["status_a33"].update(positive, text_color='green')
            janela['be33'].update(visible=False)
            janela['bp33'].update(visible=True)
        else:
            janela["status_a33"].update(negative, text_color='red')
            janela['be33'].update(visible=True)
            janela['bp33'].update(visible=False)
